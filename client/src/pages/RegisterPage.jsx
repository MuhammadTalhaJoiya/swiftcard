    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-900 flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-zinc-400 text-base leading-relaxed max-w-sm">
            Create a free account and get access to thousands of products with fast, reliable delivery.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-zinc-50">
        <div className="w-full max-w-sm">
          ...
          <p className="text-zinc-500 text-sm mb-8">Free to join. Start shopping right away.</p>
          ...
          <p className="text-center text-sm text-zinc-500 mt-6">
            ...
            <Link to="/login" className="text-amber-600 font-semibold hover:text-amber-500 transition-colors">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
